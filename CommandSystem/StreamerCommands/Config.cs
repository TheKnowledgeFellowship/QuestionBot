...
namespace QuestionBot.CommandSystem.StreamerCommands
{
    public class Config : IStreamerCommand
    {
        ...
        public string Help() => "The Config command provides sub-commands to configure different settings. Usage: `(prefix)Config [ QuestionRecognitionMode / TwitchQuestionCommandPrefix ]`.";
    }
}
